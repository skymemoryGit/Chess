...
public class alfiereN extends Pezzo {
	private ArrayList<Point>ls=new ArrayList<Point>();
	
	// costruttore 
	public alfiereN(){
		super.id="alfiereN";  // prende id dalla classe madre(Pezzo)
		super.idgruppo="N";
	}
	...
	public  void calcoloMossePossibili(int x, int y) {
		this.ls.clear(); 
		//L''alfiere può muoversi in 4 direzioni diversi diagonalmente
	...
	public void addPointDiagonaleDestraDown(int x,int y){	//x++ yy++
	...
	public void setIcona(int riga,int colonna){
		...
		b.setIcon(new ImageIcon("AlfiereN_sfchiaro0000.jpg"));
		}
		else { // scuro
			b.setIcon(new ImageIcon("AlfiereN_sfscuro0000.jpg"));
		}
	}
