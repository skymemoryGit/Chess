...
public class torreB extends Pezzo{
	...
	public  void calcoloMossePossibili(int x, int y) {
		this.ls.clear();  // questo è importante,perchè altrimenti saranno presenti anche le mosse vecchie!
	...
	public void setIcona(int riga,int colonna){
		...
		b.setIcon(new ImageIcon("TorreN_sfC0000.jpg"));
		}
		else { // scuro
			b.setIcon(new ImageIcon("TorreB_sfS0000.jpg"));
		}
	}
