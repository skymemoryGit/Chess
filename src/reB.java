...
public class reB extends Pezzo{
	...
	private boolean MaiSpostato=true;  //boolean che mi dice se questo pezzo si è mai mosso
	...
	public void primopunto(int x,int y){
				...
				if(! super.c.getMatrice()[x-1][y-1].getidgruppo().equals("B")){ // può andare in questa cella solo se non c'è un suo pezzo alleato
	...
	public void secondopunto(int x,int y){
				...
				if(! super.c.getMatrice()[x-1][y].getidgruppo().equals("B")){ // può andare in questa cella solo se non c'è un suo pezzo alleato
	...
	public void quartopunto(int x,int y){
		...
		if(! super.c.getMatrice()[x][y+1].getidgruppo().equals("B")){ // può andare in questa cella solo se non c'è un suo pezzo alleato
